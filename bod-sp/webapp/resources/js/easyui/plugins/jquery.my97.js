...
(function ($) {
    ...
    function destroy(target) {
        ...
        var input = my97.find("input.my97-text");
    ...
    function resize(target, width) {
        ...
        my97._outerWidth(opts.width)._outerHeight(opts.height);
        input._outerWidth(my97.width()-arrowWidth);
        input.css({height:my97.height()+"px",lineHeight:my97.height()+"px"});
        arrow._outerHeight(my97.height());
    }
    ...
    $.fn.my97 = function (options, param) {
        ...
        return this.each(function () {
            ...
            resize(this, state.options.width);
    ...
    $.fn.my97.parseOptions = function (target) {
        ...
        return $.extend({}, $.fn.validatebox.parseOptions(target), $.parser.parseOptions(target, 
        	["width", "height", "weekMethod", "lang", "skin", "dateFmt", "realDateFmt", 'realTimeFmt', 'realFullFmt', 'minDate', 'maxDate', 'startDate',
            {
